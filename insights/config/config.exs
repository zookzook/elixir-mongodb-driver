...
config :insights, InsightsWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: InsightsWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Insights.PubSub,
  live_view: [signing_salt: "x7TkPhml"]
...
config :insights, Insights.Mailer, adapter: Swoosh.Adapters.Local
