defmodule Insights.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule InsightsWeb.Endpoint do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: InsightsWeb.Router, endpoint: InsightsWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # Insights.Users.PromExPlugin
      {PromEx.Plugins.MongoDB, otp_app: :insights}
    ]
  end
  ...
  def dashboards do
    [
      ...
      {:insights, "/grafana_dashboards/mongodb_driver.json"}
    ]
  end
end
